<p align="center">
  <img src="docs/brand/banner.png" alt="Nhako Tools: the app icon, a red pixel-art toolbox on a lawn, next to the words Built for the big screen., and a laptop showing the Nhako Tools home page beside a tablet running the teleprompter" width="100%">
</p>
...
<p align="center">
  ...
  &nbsp;|&nbsp;
  <a href="launch/nhako-tools-film.mp4">Launch film</a>
  &nbsp;|&nbsp;
...
- [Launch film and posters](#launch-film-and-posters)
...
## Launch film and posters

<a href="launch/nhako-tools-film.mp4"><img src="launch/posters/hero.png" width="100%" alt="The hero poster: Built for the big screen. 50 free tools for your laptop and tablet. A laptop shows the Nhako Tools home page, a tablet beside it runs the teleprompter, and pixel butterflies fly around them."></a>

**[launch/nhako-tools-film.mp4](launch/nhako-tools-film.mp4)**: 60 seconds,
widescreen 1920 x 1080, for YouTube, X, LinkedIn and a slide.

Styled like an Apple keynote film, with a hint of NeraOS: the site's pixel
butterflies fly in the air around the devices and never cross a screen (a
check renders every frame to prove it). The film shows a laptop and a tablet,
because that is what Nhako Tools is built for: search that understands Malay,
the Malaysian salary calculator on LHDN's own example, the Malaysia
collection, the teleprompter scrolling a final-year presentation at a real
140 wpm, the CGPA planner, both languages and dark mode. The score is original
and generated by code.

Posters in **[launch/posters/](launch/posters)**, from the same code: `hero`
(16:9), `teleprompter`, `malaysia` and `students` (4:5, for the Instagram
feed), and `story` (9:16). Storyboard, sources for every number, the
butterfly rule and how to rebuild: **[docs/launch-film.md](docs/launch-film.md)**.

<p>
  <img src="launch/posters/teleprompter.png" width="32%" alt="Poster: Read it. Record it. A tablet runs the teleprompter.">
  <img src="launch/posters/malaysia.png" width="32%" alt="Poster: Your real take-home pay. The Malaysian salary calculator on a laptop, and the Malaysia collection on a tablet.">
  <img src="launch/posters/students.png" width="32%" alt="Poster: Every semester job. One site. The home page on a laptop, the CGPA calculator on a tablet.">
</p>

The earlier vertical cut for phones,
**[launch/nhako-tools-launch.mp4](launch/nhako-tools-launch.mp4)** (58 s,
1080 x 1920, for Reels, TikTok and Shorts), is documented in
...
launch/film/    the widescreen launch film and posters: capture, timeline, scene, posters, check, renderer
launch/video/   the vertical phone video, and the soundtrack generator both films use
docs/           the Android plan, the films' documentation, brand art
...
| `npm run launch:film` | Rebuild the widescreen film, the posters and the banner from a running preview (see [docs/launch-film.md](docs/launch-film.md)) |
| `npm run launch:video` | Rebuild the vertical phone video from a running preview (see [docs/launch-video.md](docs/launch-video.md)) |
